                                ...
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        <div class="product__discount__item__pic set-bg"
                                            data-setbg="resources/img/product/2019_img/susan_main5_01.jpg">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h5><a href="${root}/shopdetails_eungalchi">제주 은갈치 (中) -추동-<br>3~12마리 36,000원 부터~</a></h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                   <h5><a href="${root}/shopdetails_eungalchi">제주 은갈치 (大) -추동-<br>3~12마리 48,000원 부터~</a></h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h5><a href="#">제주 은갈치 (특대) -추동-<br>2~8마리 59,000원 부터~</a></h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h5><a href="#">제주 은갈치 (왕특) -추동-<br>2~8마리 86,000원 부터~</a></h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h5><a href="#">제주 통은갈치 (대/ 특/ 왕) -추동-<br>3kg/ 5kg 107,000원 부터~</a></h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h5><a href="#">제주 은갈치/ 통갈치 (중,대,특,왕)<br>3~4마리 36,000원 부터~</a></h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h5><a href="#">제주수산물 -알뜰세트-<br>30,000원 부터~</a></h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h5><a href="#">제주수산물 -일반세트-<br>54,000원 부터~</a></h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h5><a href="#">[GOLD]골드수산세트 -추동은갈치-<br>특/ 왕 135,000원 부터~</a></h5>
                                </div>
                            </div>
                        </div>
                    </div>
